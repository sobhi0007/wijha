<form action="{{ route('admin.types.update', ['type' => $type]) }}" method="post" id="edit_form"
    ...
    <div class="row">
        <div class="form-group col-12 col-md-6">
            ...
            <input type="text" class="border form-control" name="name_en"
                placeholder="{{ __('lang.please_enter') }} {{ __('lang.name') }}..." value="{{ $type->name_en }}">
        </div>

        <div class="form-group col-12 col-md-6">
            <label class="form-label">{{ __('lang.name') }} {{ lang('ar') }}</label>
            <input type="text" class="border form-control" name="name_ar"
                placeholder="{{ __('lang.please_enter') }} {{ __('lang.name') }}..." value="{{ $type->name_ar }}">
        </div>
    </div>
