...
<div class="card">
    <div class="card-body">
        ...
        <form action="{{ route('admin.units.update', ['unit' => $unit]) }}" method="post" id="edit_form"
            ...
            <div class="row">
                        ...
                        <div class="form-group col-12 col-md-3">
                            ...
                            <div name="basic[user_id]">
                                <select class="border form-control select2" name="basic[user_id]" id="user_id">
                                    ...
                                    <option value="{{ $item->id }}" @selected($unit->user_id == $item->id)>
                                        {{ $item->name }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div name="basic[category_id]">
                                <select class="border form-control select2" name="basic[category_id]" id="category_id">
                                    ...
                                    <option value="{{ $item->id }}" @selected($unit->category_id == $item->id)>
                                        {{ LaravelLocalization::getCurrentLocale() == 'en' ? $item->name_en :
                                        $item->name_ar }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group col-12 col-md-3">
                            ...
                            <div name="basic[status]">
                                <select class="form-control select2" name="basic[status]">
                                    ...
                                    <option value="{{ $item->value }}" @selected($unit->status == $item)>
                                        {{ $item->lang() }}</option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-12">
                            ...
                            <textarea type="text" class="border form-control" name="basic[description]"
                                placeholder="{{ __('lang.please_enter') }} {{ __('lang.description') }}..."
                                rows="4">{{ $unit->description }}</textarea>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-12 col-md-3">
                            ...
                            <div name="basic[capacity_id]">
                                <select class="border form-control select2" name="basic[capacity_id]" id="capacity_id">
                        ...
                        <div class="form-group col-12 col-md-3">
                            ...
                            <div name="basic[badge_id]">
                                <select class="border form-control select2" name="basic[badge_id]" id="badge_id">
                                    ...
                                    <option value="{{ $item->id }}" @selected($unit->badge_id == $item->id)>
                                        {{ LaravelLocalization::getCurrentLocale() == 'en' ? $item->name_en :
                                        $item->name_ar }}
                                    </option>
                                    @endforeach
                        ...
                        <div class="form-group col-12">
                            ...
                            <div name="kitchens[]">
                                ...
                                <div class="custom-control custom-checkbox d-inline mr-2">
                                    ...
                                    <label class="custom-control-label" for="customCheckKitchen{{ $item->id }}">
                                        {{ LaravelLocalization::getCurrentLocale() == 'en' ? $item->name_en :
                                        $item->name_ar }}
                                    </label>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-12">
                            ...
                            <textarea type="text" class="border form-control" name="extra[rules]"
                                placeholder="{{ __('lang.please_enter') }} {{ __('lang.rules') }}..."
                                rows="2">{{ $unit->unitData?->rules }}</textarea>
                        </div>
                        ...
                        <div class="form-group col-12">
                            ...
                            <textarea type="text" class="border form-control" name="extra[arrival_instructions]"
                                placeholder="{{ __('lang.please_enter') }} {{ __('lang.arrival_instructions') }}..."
                                rows="2">{{ $unit->unitData?->arrival_instructions }}</textarea>
                        </div>
                        ...
                        <div class="form-group col-12">
                            ...
                            <textarea type="text" class="border form-control" name="extra[cancellation_policy]"
                                placeholder="{{ __('lang.please_enter') }} {{ __('lang.cancellation_policy') }}..."
                                rows="2">{{ $unit->unitData?->cancellation_policy }}</textarea>
                        </div>
                        ...
                        <div class="form-group col-12">
                            ...
                            <textarea type="text" class="border form-control" name="extra[parking_information]"
                                placeholder="{{ __('lang.please_enter') }} {{ __('lang.parking_information') }}..."
                                rows="2">{{ $unit->unitData?->parking_information }}</textarea>
                        </div>
                        ...
                        <div class="form-group col-12">
                            ...
                            <textarea type="text" class="border form-control" name="extra[wifi_information]"
                                placeholder="{{ __('lang.please_enter') }} {{ __('lang.wifi_information') }}..."
                                rows="2">{{ $unit->unitData?->wifi_information }}</textarea>
                        </div>
                ...
                <div class="border border-primary rounded p-2 mt-3 col-12">
                    <div class="card-header bg-light p-1">
                        ...
                        <a href="#" class="btn btn-sm btn-info p-1 pt-0 pb-0" id="add_new_item">{{
                            __('lang.add_new_time') }}</a>
                    </div>
                            ...
                            <div class="row item_row">
                                <div class="form-group col-sm-12 col-md-3">
                                    ...
                                    <input type="date" class="border form-control" name="fromDate[]"
                                        placeholder="{{ __('lang.fromDate') }}..." value="{{ $time->from }}"
                                        min="<?= date('Y-m-d') ?>">
                                </div>

                                <div class="form-group col-sm-12 col-md-3">
                                    <label class="form-label">{{ __('lang.toDate') }}</label>
                                    <input type="date" min="1" class="border form-control" name="toDate[]"
                                        placeholder="{{ __('lang.toDate') }}..." value="{{ $time->to }}"
                                        min="<?= date('Y-m-d') ?>">
                                </div>
                                ...
                                <div class="form-group col-sm-12 col-md-2">
                                    ...
                                    <input type="number" min="1" class="border form-control" name="price[]"
                                        placeholder="{{ __('lang.price') }}..." value="{{ $time->price }}">
                                </div>
                                ...
                                <div class="form-group col-12 col-md-3">
                                    ...
                                    <div name="availability[]">
                                        <select class="form-control" name="availability[]">
                                            ...
                                            <option value="{{ $item->value }}" @selected($time->availability == $item)>
                                                {{ $item->lang() }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                        ...
                        <div class="form-group col-12">
                            ...
                            <div class="custom-file" name="images">
                                ...
                                <input type="file" class="custom-file-input" id="customFile" name="images[]"
                                    placeholder="{{ __('lang.please_enter') }} {{ __('lang.images') }}..." multiple>
                            </div>
                        </div>

                    </div>
                    @livewire('gallary', ['unit' => $unit])
...
<div class="row item_row d-none" id="item_to_copy">
    <div class="form-group col-sm-12 col-md-3">
        <label class="form-label">{{ __('lang.fromDate') }}</label>
        <input type="date" class="border form-control" name="fromDate[]" placeholder="{{ __('lang.fromDate') }}..."
            min="<?= date('Y-m-d') ?>">
    </div>
    ...
    <div class="form-group col-sm-12 col-md-2">
        <label class="form-label">{{ __('lang.price') }}</label>
        <input type="number" min="1" class="border form-control" name="price[]" placeholder="{{ __('lang.price') }}...">
    </div>
...
<script async
    src="https://maps.googleapis.com/maps/api/js?key={{env('MAP_API_KEY')}}&callback=initMap&language=<?=Lang::locale()?>">
</script>
<script>
    let map;
