                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-12 col-md-3">
                                ...
                                <div name="basic[bedrooms_number]">
                                    <input  value="{{ $unit->bedrooms_number}}"  type="number" class="border form-control " name="basic[bedrooms_number]" id="bedrooms_number" placeholder="{{ __('lang.select_bedrooms_number') }}">
                            ...
                            <div class="form-group col-12 col-md-3">
                                ...
                                <div name="basic[bathrooms_number]">
                                    <input  value="{{ $unit->bathrooms_number}}"  type="number" class="border form-control " name="basic[bathrooms_number]" id="bathrooms_number" placeholder="{{ __('lang.select_bathrooms_number') }}">
