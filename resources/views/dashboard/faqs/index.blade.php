...
@section('faqs_active', 'active bg-light')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h2 class="h5 page-title">{{ __('lang.faqs') }}</h2>

                @if (permission(['add_faqs']))
                    <div class="page-title-right">
                        <a href="{{ route('admin.faqs.create') }}" data-title="{{ __('lang.add_new_faq') }}" id="add_btn"
                ...
                <table class="table align-middle table-nowrap font-size-14">
                    <thead class="bg-light">
                        <tr>
                            ...
                            <th class="text-primary">{{ __('lang.faq') }} {{ lang('en') }}</th>
                            <th class="text-primary">{{ __('lang.faq') }} {{ lang('ar') }}</th>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                @if (permission(['show_faqs']))
                                                    <a href="{{ route('admin.faqs.show', ['faq' => $item]) }}"
                                                        class="dropdown-item displayClass"
                                                        data-title="{{ __('lang.show_faq') }}" data-toggle="modal"
                                                ...
                                                @if (permission(['edit_faqs']))
                                                    <a href="{{ route('admin.faqs.edit', ['faq' => $item]) }}"
                                                        class="dropdown-item editClass"
                                                        data-title="{{ __('lang.edit_faq') }}" data-toggle="modal"
                                                        data-target="#mainModal">
                                                ...
                                                @if (permission(['delete_faqs']))
                                                    <a class="dropdown-item deleteClass"
                                                        href="{{ route('admin.faqs.destroy', ['faq' => $item]) }}"
                                                        data-title="{{ __('lang.delete_faq') }}" data-toggle="modal"
