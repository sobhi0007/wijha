...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('owner.units.store') }}" method="post" id="add_form" enctype="multipart/form-data">
                @csrf
    ...
    <script async src="https://maps.googleapis.com/maps/api/js?key=API_KEYQ&callback=initMap"></script>
    <script>
        let map;
        var markersArray = [];
