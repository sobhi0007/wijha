        ...
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <a href="{{ route('owner.units.create') }}" data-title="{{ __('lang.add_new_unit') }}"
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a href="{{ route('owner.units.show', ['unit' => $item]) }}"
                                                    class="dropdown-item">
                                                    <span class="bx bx-show-alt"></span>
                                                    {{ __('lang.show') }}
                                                </a>

                                                <a href="{{ route('owner.units.edit', ['unit' => $item]) }}"
                                                    class="dropdown-item">
                                                ...
                                                {{-- <a class="dropdown-item deleteClass"
                                                    href="{{ route('owner.units.destroy', ['unit' => $item]) }}"
