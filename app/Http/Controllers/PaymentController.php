...
{
    const DIRECTORY = 'dashboard.payments';

    function __construct()
    {
        $this->middleware('check_permission:list_payments')->only(['index', 'getData']);
        $this->middleware('check_permission:add_payments')->only(['create', 'store']);
        $this->middleware('check_permission:show_payments')->only(['show']);
        $this->middleware('check_permission:edit_payments')->only(['edit', 'update']);
        $this->middleware('check_permission:delete_payments')->only(['destroy']);
    }
    ...
    public function getData($data)
    {
        ...
        $data = Payment::when($word != null, function ($q) use ($word) {
