...
class StoreUnitRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $rules = [
            'basic.user_id'              => 'nullable|exists:users,id',
            ...
            'basic.bathrooms_number'     => 'required|min:0|numeric',
            'basic.bedrooms_number'     => 'required|min:0|numeric',
    ...
    {
        return [
            'basic.user_id'              => __('lang.user'),
            'basic.category_id'          => __('lang.category'),
            'basic.status'               => __('lang.status'),
            ...
            'basic.bathrooms_number'     => __('lang.bathrooms_number'),
            'basic.bedrooms_number'     => __('lang.bedrooms_number'),
            'pools'                      => __('lang.pools'),
            'pools.*'                    => __('lang.pools'),
            'views'                      => __('lang.views'),
            'views.*'                    => __('lang.views'),
